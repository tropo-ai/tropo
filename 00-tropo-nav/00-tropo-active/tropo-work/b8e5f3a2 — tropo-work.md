...
**🌳 Tropo-Nav Path** (chat): [tropo-os-v1.84.1/00-tropo-nav/00-tropo-active/tropo-work/b8e5f3a2 — tropo-work.md](tropo-os-v1.84.1/00-tropo-nav/00-tropo-active/tropo-work/b8e5f3a2%20%E2%80%94%20tropo-work.md)

**🔗 This file** — UID `b8e5f3a2` · type `project` · state `active` · status `active`

**↓ Children (8):**
  - **pipeline (7):** [app-pipeline](2918e3b4.md) · [dev-pipeline](cd1fcd25.md) · [doc-pipeline](5a4337ff.md) · [publish-pipeline](e2f4a8c1.md) · [test-pipeline](da3f50dc.md) · [vault-ops-pipeline](9dab87a0.md) · [web-pipeline](7b2e94c1.md)
  - **project:** [Hello Tropo — 2026 Customer Event Plan](e8d1a4f6.md)
<!-- nav-block:end -->
