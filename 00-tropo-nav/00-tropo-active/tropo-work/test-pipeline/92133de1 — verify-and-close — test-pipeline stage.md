...
**🌳 Tropo-Nav Path** (chat): [tropo-os-v1.84.1/00-tropo-nav/00-tropo-active/tropo-work/test-pipeline/92133de1 — verify-and-close — test-pipeline stage.md](tropo-os-v1.84.1/00-tropo-nav/00-tropo-active/tropo-work/test-pipeline/92133de1%20%E2%80%94%20verify-and-close%20%E2%80%94%20test-pipeline%20stage.md)
...
**↔ Siblings (2):**
  - **under [test-pipeline](da3f50dc.md):** [execute — test-pipeline stage](2e097029.md) · [prepare — test-pipeline stage](69c291b7.md)
