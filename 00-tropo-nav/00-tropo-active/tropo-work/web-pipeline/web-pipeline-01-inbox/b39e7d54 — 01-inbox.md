...
**🌳 Tropo-Nav Path** (chat): [tropo-os-v1.84.1/00-tropo-nav/00-tropo-active/tropo-work/web-pipeline/web-pipeline-01-inbox/b39e7d54 — 01-inbox.md](tropo-os-v1.84.1/00-tropo-nav/00-tropo-active/tropo-work/web-pipeline/web-pipeline-01-inbox/b39e7d54%20%E2%80%94%2001-inbox.md)

**🔗 This file** — UID `b39e7d54` · type `project` · state `active` · status `active`

**↓ Children (2):**
  - **note (2):** [Hosting research — tropo-ai.com host selection ...](f4a82d61.md) · [Website strategic expansion — from marketing su...](e8d3a275.md)

**↔ Siblings (12):**
  - **under [web-pipeline](7b2e94c1.md):** [Agent-Builder Wizard — Design Brief](3a8d92c1.md) · [build — web-pipeline stage](c6e29a47.md) · [deploy — web-pipeline stage](84d15fb9.md) · [GitHub Releases Integration — Design Brief](8b3c1d72.md) · [OSS License Research — Apache 2.0 vs MIT for Tr...](b7e9c41d.md) · [specify — web-pipeline stage](a3f81d52.md) · + 6 more
<!-- nav-block:end -->
