...
1. A proposal recorded as a vault entry of `type: decision` (use [vault/actions/tropo-create-decision.md](vault/actions/tropo-create-decision.md), which ships in your vault; or author the vault entry directly per [vault/capsules/tropo-decision.capsule.md](vault/capsules/tropo-decision.capsule.md)).
