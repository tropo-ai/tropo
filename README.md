...
- **Memory that survives.** When a session ends, the work persists. When an agent is replaced, knowledge transfers.
...
Tropo grows through what people build with it: agents, capsules, and studio templates. See [CONTRIBUTING.md](CONTRIBUTING.md), and show us what you made.
...
*Tropo-OS v1.73.0 | The file is the agent. The folder is the workspace. The vault is the OS.*
