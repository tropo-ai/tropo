...
- release_dir: `tropo-os-v1.96.0` (basename only — this file ships)
- mode: mechanical (deterministic regression; the guided stranger-walk is the playbook's other half)
- result: **12/12 checks passed**
- stats: {'index_rows': 504, 'uids': 504, 'version': 'v1.96.0', 'capsule_defs': 1}

| Check | Verdict | Detail |
|---|---|---|
| required files/dirs present | ✓ PASS | all present |
| index parses (every row valid JSON + uid/type) | ✓ PASS | 504 rows, 0 malformed |
| version stamped | ✓ PASS | version = v1.96.0 |
...
| START-TROPO.md non-empty | ✓ PASS | 84 non-blank lines |
| tropo-validate.py present and non-empty | ✓ PASS | present (805554 bytes) |
| shipped Python lib import closure | ✓ PASS | 121 tools, 102 lib modules resolved |
