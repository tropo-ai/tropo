...
| tropo-validate.py present and non-empty | ✓ PASS | present (702422 bytes) |
| shipped Python lib import closure | ✓ PASS | 105 tools, 85 lib modules resolved |
