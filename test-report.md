...
- release_dir: `/tropo-releases/v1.87.0/builds/tropo-os-v1.87.0`
- mode: mechanical (deterministic regression; the guided stranger-walk is the playbook's other half)
- result: **11/11 checks passed**
- stats: {'index_rows': 483, 'uids': 483, 'version': 'v1.87.0', 'capsule_defs': 1}

| Check | Verdict | Detail |
|---|---|---|
| required files/dirs present | ✓ PASS | all present |
| index parses (every row valid JSON + uid/type) | ✓ PASS | 483 rows, 0 malformed |
| version stamped | ✓ PASS | version = v1.87.0 |
...
| tropo-validate.py present and non-empty | ✓ PASS | present (663326 bytes) |
| shipped Python lib import closure | ✓ PASS | 93 tools, 77 lib modules resolved |
