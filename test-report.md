...
- release_dir: `tropo-os-v1.92.0` (basename only — this file ships)
- mode: mechanical (deterministic regression; the guided stranger-walk is the playbook's other half)
- result: **12/12 checks passed**
- stats: {'index_rows': 498, 'uids': 498, 'version': 'v1.92.0', 'capsule_defs': 1}

| Check | Verdict | Detail |
|---|---|---|
| required files/dirs present | ✓ PASS | all present |
| index parses (every row valid JSON + uid/type) | ✓ PASS | 498 rows, 0 malformed |
| version stamped | ✓ PASS | version = v1.92.0 |
...
| tropo-validate.py present and non-empty | ✓ PASS | present (738264 bytes) |
