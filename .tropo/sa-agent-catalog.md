...
**5 session agents** registered in this Studio.
...
⚠️ **WARNING — `trigger_description:` missing.** Sa.* registration is incomplete.

**Activation file.** [agents/sa/sa.cold-boot/sa.cold-boot.md](../agents/sa/sa.cold-boot/sa.cold-boot.md)

**UID.** `299f7d4e` | governed by [`session-agent.capsule v1.4`](capsules/session-agent.capsule.md)
...
**Activation file.** [agents/sa/sa.pipeline-walker/sa.pipeline-walker.md](../agents/sa/sa.pipeline-walker/sa.pipeline-walker.md)

**UID.** `ba9b3b56` | governed by [`session-agent.capsule v1.4`](capsules/session-agent.capsule.md)
...
*Tropo sa.\* Agent Catalog | Generated 2026-07-11 | v1.15 substrate*
