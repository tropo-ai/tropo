...
**Reference:** The project capsule definition at `vault/capsules/tropo-project.capsule.md` defines what a valid project IS. This action defines how to CREATE one.
...
3. **The project capsule definition exists** at `vault/capsules/tropo-project.capsule.md`.
...
*Reads (v3.1): `vault/capsules/tropo-project.capsule.md` (v2.1), `vault/capsules/tropo-board-definition.capsule.md`, `vault/AGENTS.md`, `vault/00-index.jsonl` (for project-board default triple lookup).*
