...
**Reference:** [`vault/capsules/tropo-collection-ref.capsule.md`](../capsules/collection-ref.capsule.md) and Phase 1 spec §7.
...
*Reads: `vault/capsules/tropo-collection-ref.capsule.md`*
