...
**Reference:** [`vault/capsules/tropo-design-brief.capsule.md`](../capsules/design-brief.capsule.md)
...
1. **The Vault exists.**
2. **The design-brief capsule definition exists** at `vault/capsules/tropo-design-brief.capsule.md`.
...
*Reads: `vault/capsules/tropo-design-brief.capsule.md`*
