...
**Reference:** The note capsule definition at [`vault/capsules/tropo-note.capsule.md`](../capsules/note.capsule.md) defines what a valid note IS. This action defines how to CREATE one.
...
2. **The note capsule definition exists** at `vault/capsules/tropo-note.capsule.md`.
...
*Reads: `vault/capsules/tropo-note.capsule.md`*
