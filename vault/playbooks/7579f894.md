...
*Sprint 2 first-instance test-harness playbook. Codifies the walker dispatch protocol previously held in V36/V35 session memory. Per [The Patient Honing Doctrine](../../.tropo-studio/memory/entries/a9d7c364.md): the workshop IS the system; the system compensates for forgetting. Walker dispatch is workshop primitive from v1.4.2 forward.*
