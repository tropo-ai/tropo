...
cli_command: python3 vault/tools/tropo-validate-capability-membership.py [--soft] [--vault-path PATH]
script_path: vault/tools/tropo-validate-capability-membership.py
input:
  type: object
  properties:
    soft:
...
_RULE14_PATTERNS: list[tuple[str, str]] = [
    ...
    (r'^vault/capsules/.*\.capsule\.md$',    '8dd772a0'),  # tropo-governance (ADR-045: moved from .tropo/capsules/)
