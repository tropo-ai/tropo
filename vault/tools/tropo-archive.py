...
cli_command: "python3 vault/tools/tropo-archive.py <uid> --reason <reason> [--superseded-by <uid>] [--unarchive] [--force-with-reason <reason>] [--actor <label>]"
script_path: vault/tools/tropo-archive.py
spawnable_by:
  - all-executives
input:
  type: object
...
belt: true
belt_invocation: "python3 vault/tools/tropo-archive.py <uid> --reason <reason>"
belt_example: "python3 vault/tools/tropo-archive.py 8f6ea459 --reason \"superseded\""
---
"""
...
def _emit(event_type: str, uid: str, actor: str, reason: str, superseded_by=None):
    try:
        _spec = _ilu.spec_from_file_location(
            "_emit_tool", VAULT_ROOT / "vault" / "tools" / "tropo-emit-event.py"
        )
        ...
        subprocess.run(
            [sys.executable, str(VAULT_ROOT / "vault" / "tools" / "tropo-emit-event.py"),
             "--type", event_type,
             "--source", "/tools/archive",
             "--source-uid", "6cc9dcdb",
             "--lifecycle", "evergreen",
