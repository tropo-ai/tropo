...
script_path: vault/tools/tropo-scan-import-state.py
transport: cli
implementation_kind: python-script
cli_command: python3 vault/tools/tropo-scan-import-state.py [--output-dir <dir>]
spawnable_by:
- all-executives
destructive: 'false'
...
- 76bab75f
belt: true
belt_invocation: "python3 vault/tools/tropo-scan-import-state.py --output-dir <dir>"
belt_example: "python3 vault/tools/tropo-scan-import-state.py --output-dir agents/talos/..."
---
"""
