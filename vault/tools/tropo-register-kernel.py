...
cli_command: python3 vault/tools/tropo-register-kernel.py [--dry-run]
script_path: vault/tools/tropo-register-kernel.py
input:
  type: object
  properties:
    dry-run:
...
import secrets
import sys
import importlib.util as _ilu_rk
...
_mint_spec_rk = _ilu_rk.spec_from_file_location(
    "_mint_id_canonical_rk", _Path_rk(__file__).resolve().parent / "tropo-mint-id.py"
)
