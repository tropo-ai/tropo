...
meta_status_rollup:
  in-progress:
    ...
    - stale
    - archived
rollup_archived_added: argus-a123 2026-07-03 — +archived→done in meta_status_rollup per the Mike-directed v3 triage (brief dd8df3bf; 30 legacy activation entries archived by canonical tool); additive, bucket-only per the a104 precedent (enums unchanged); flagged to Mike in-session
schema_version: 2
...
tags:
  ...
  - activation
  - agent-lifecycle
  - level-2-composable-graph
  - adr-016-substrate-invariant
  - adr-028-substrate-invariant
  - 5-section-pedagogy
  - v1.21.0-stream-1-authored
  - replaces-generation-log-capsule
subsystem_hub:
  - 8dd772a0
  - 99ed55fd
---
