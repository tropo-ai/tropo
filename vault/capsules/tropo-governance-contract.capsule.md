...
tags:
  ...
  - governance-contract
  - lock-c-layer-2
  - folder-level-governance
  - 5-section-pedagogy
  - v1.20.0-stream-a-authored
subsystem_hub:
  - 8dd772a0
---
...
| `validator_extension` | UID | Link to a validator check (or set of checks) in `vault/tools/tropo-validate.py` that enforces this folder's invariants beyond the schema-level checks. |
