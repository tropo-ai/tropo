...
**Tools available:**
- `python3 vault/tools/tropo-validate.py` — runs capsule checks including project.capsule v2.3's 9 checks
- `python3 vault/tools/tropo-rebuild-vault.py --apply` — regenerates indexes; confirms `member_of:` graph integrity
