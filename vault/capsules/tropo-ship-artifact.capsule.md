...
tags:
  ...
  - ship-artifact
  - 5-section-pedagogy
  - v1.3-multi-target-extraction
  - v1.4-article-state-publish-act-staging-composition
subsystem_hub:
  - 8dd772a0
---
...
5. build-web-content.py runs (the thin-orchestrator at `vault/tools/11f3ebd4.py`; publish-act + sync hooks per design-spec [6a8d3f17](../../vault/files/6a8d3f17.md) §6):
