...
rollup_archived_added: argus-a123 2026-07-03 — +archived→done in meta_status_rollup per the Mike-directed v3 triage (brief dd8df3bf; 30 legacy doc-spec entries archived by canonical tool); additive, bucket-only per the a104 precedent (enums unchanged); flagged to Mike in-session
schema_version: 2
...
- **Surface:** Capsule definitions (vault/capsules/*.capsule.md); architectural specs (vault/files/<uid>.md type:arch-spec OR type:design-spec); ADRs; locked governance docs
