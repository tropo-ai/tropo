...
aligned_with: 0c61a52b
history_companion: 323d0966
subsystem_hub:
  - 99ed55fd
---
...
| `aliases` | list of strings | Known nicknames/short-names the agent answers to (e.g., `aliases: [Ori, Phe]`). Read at Group 2 identity resolution — already-loaded frontmatter, no new boot step. Aliases live HERE so they survive roster trims and boot-cost diets (v2.1; the Phe-phantom fix 5427bee9 — a pruned nickname was reconstructed as a phantom separate agent). Rendered surfaces (crew-brief Aliases column) derive from this field, never the reverse. |
...
*agent capsule definition | v2.1 | Argus A124 | 2026-07-03 | v2.0 per Mike-locked v1.69 dev-spec 0c61a52b; v2.1 aliases field per 5427bee9*
