...
| `studio` | Crew-class knowledge — shared doctrine, vault-level crew memory, crew-wide operating facts | `.tropo-studio/memory/entries/<uid>.md` |
...
*memory.capsule v1.3 | UID a5b3c891 | Authored 2026-05-12 | Amended 2026-06-14 by Talos T20 per Metis-G80 (00003705) | Amended 2026-07-03 by Talos T24 per dev-spec 8c015275 (Position 1 + write contract) | Ships in v1.26.0 · v1.78.0*
