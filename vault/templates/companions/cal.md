...
- `agents/cal/.tropo-capsule/memory/agent-memory.md` <!-- tropo-boot-read {"id":"memory-agent-memory","path":"agents/cal/.tropo-capsule/memory/agent-memory.md","applicability":"required"} -->
- `agents/cal/.tropo-capsule/memory/method-pins.jsonl` <!-- tropo-boot-read {"id":"memory-method-pins","path":"agents/cal/.tropo-capsule/memory/method-pins.jsonl","applicability":"required"} -->
- `agents/cal/.tropo-capsule/memory/crew-memories.jsonl` <!-- tropo-boot-read {"id":"memory-crew-memories","path":"agents/cal/.tropo-capsule/memory/crew-memories.jsonl","applicability":"required"} -->
